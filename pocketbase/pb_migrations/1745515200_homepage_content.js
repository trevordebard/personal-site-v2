migrate(
  (app) => {
    ...
    homepageRecord.set('hero_eyebrow', 'Software Consultant / Product Engineer')
    homepageRecord.set('greeting', "Hi, I'm Trevor DeBardeleben")
    homepageRecord.set('location', 'Atlanta, GA')
    homepageRecord.set('availability', 'Open to thoughtful product and platform work')
    homepageRecord.set('title', 'Senior software consultant building durable product systems.')
    homepageRecord.set(
      'intro',
    ...
    const statValues = [
      { sort: 1, value: '8+', label: 'years building on the web' },
      { sort: 2, value: '4', label: 'roles represented here' },
      { sort: 3, value: '3', label: 'featured personal projects' },
    ]
